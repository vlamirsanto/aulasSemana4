...
@interface aulasSemana4Object : KrollCoverageObject {
#else
@interface aulasSemana4Object : KrollObject {
#endif
@private
...
extern NSString * aulasSemana4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	aulasSemana4Object *_aulassemana4;
    KrollObject* console;
	BOOL shutdown;
