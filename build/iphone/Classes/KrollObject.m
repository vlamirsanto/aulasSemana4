...
//@interface aulasSemana4Object : NSObject
//@end

@interface aulasSemana4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[aulasSemana4Object class]])
		{
			for (NSString *key in [[(aulasSemana4Object*)o modules] allKeys])
			{
