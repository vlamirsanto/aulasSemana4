...
// in simulator we redefine to format for aulasSemana4 Developer console
...
{\
	NSString * exceptionName = [@"org.aulassemana4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.aulassemana4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIaulasSemana4NativeItemNone = -1, 
	UIaulasSemana4NativeItemSpinner = -2,
	UIaulasSemana4NativeItemProgressBar = -3,
	
	UIaulasSemana4NativeItemSlider = -4,
	UIaulasSemana4NativeItemSwitch = -5,
	UIaulasSemana4NativeItemMultiButton = -6,
	UIaulasSemana4NativeItemSegmented = -7,
	
	UIaulasSemana4NativeItemTextView = -8,
	UIaulasSemana4NativeItemTextField = -9,
	UIaulasSemana4NativeItemSearchBar = -10,
	
	UIaulasSemana4NativeItemPicker = -11,
	UIaulasSemana4NativeItemDatePicker = -12,
	
	UIaulasSemana4NativeItemInfoLight = -13,
	UIaulasSemana4NativeItemInfoDark = -14,
	
	UIaulasSemana4NativeItemDisclosure = -15,
	
	UIaulasSemana4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all aulasSemana4 instances of
