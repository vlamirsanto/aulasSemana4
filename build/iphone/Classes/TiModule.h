...
/**
 The base class for all aulasSemana4 modules
 */
...
/**
 aulasSemana4 Platform calls this method on startup.
 */
-(void)startup;

/**
 aulasSemana4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 aulasSemana4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 aulasSemana4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 aulasSemana4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
