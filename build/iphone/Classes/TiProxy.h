...
//Rare exceptions to indicate a bug in the _aulassemana4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for aulasSemana4 proxies.
 */
