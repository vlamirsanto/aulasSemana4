...
/**
 Base class for all aulasSemana4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the aulasSemana4 view hierarchy (such as wrapped iOS UIViews) was touched.
